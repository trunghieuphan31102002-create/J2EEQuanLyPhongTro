...
const MENU: MenuItem[] = [
  ...
  { to: '/dashboard/bills',             label: 'Hóa đơn',         icon: 'fa-file-invoice-dollar', roles: ['ADMIN', 'OWNER', 'MANAGER', 'TENANT'] },
  { to: '/dashboard/maintenance',       label: 'Bảo trì',         icon: 'fa-screwdriver-wrench',  roles: ['ADMIN', 'OWNER', 'MANAGER', 'TENANT'] },
